...
public class ProductDetailsDto {
    ...
    public ProductDetailsDto(String code, String barcode, int qtyOnHand, double sellingPrice, boolean discountAvailability, double showPrice, int productCode, double buyingPrice) {
        this.code = code;
